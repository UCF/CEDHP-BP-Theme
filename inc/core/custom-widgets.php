...
class business_press_social_widget extends WP_Widget {
	...
	public function widget( $args, $instance )
	{
		...
		<div class="textwidget">
			...
			{
			?>
				<a title="<?php _e( 'VK', 'business-press' ); ?>" target="_blank" href="<?php echo esc_url( get_theme_mod( 'social_profile_link_vk' ) ); ?>"><span class="fa fa-vk social_profile-icon-clr"></span></a>
			<?php
			}
			?>
			...
			{
			?>
				<a title="<?php _e( 'Instagram', 'business-press' ); ?>" target="_blank" href="<?php echo esc_url( get_theme_mod( 'sprofile_link_instagram' ) ); ?>"><span class="fa fa-instagram social_profile-icon-clr"></span></a>
			<?php
			}
			?>
			...
			{
			?>
				<a title="<?php _e( 'Telegram', 'business-press' ); ?>" target="_blank" href="<?php echo esc_url( get_theme_mod( 'sprofile_link_telegram' ) ); ?>"><span class="fa fa-telegram social_profile-icon-clr"></span></a>
			<?php
			}
			?>
			...
			{
			?>
				<a title="<?php _e( 'Snapchat', 'business-press' ); ?>" target="_blank" href="<?php echo esc_url( get_theme_mod( 'sprofile_link_snapchat' ) ); ?>"><span class="fa fa-snapchat social_profile-icon-clr"></span></a>
			<?php
			}
			?>
			...
			{
			?>
				<a title="<?php _e( 'Flickr', 'business-press' ); ?>" target="_blank" href="<?php echo esc_url( get_theme_mod( 'sprofile_link_flickr' ) ); ?>"><span class="fa fa-flickr social_profile-icon-clr"></span></a>
			<?php
			}
			?>
			...
			{
			?>
				<a title="<?php _e( 'Reddit', 'business-press' ); ?>" target="_blank" href="<?php echo esc_url( get_theme_mod( 'sprofile_link_reddit' ) ); ?>"><span class="fa fa-reddit social_profile-icon-clr"></span></a>
			<?php
			}
			?>
			...
			{
			?>
				<a title="<?php _e( 'Tumblr', 'business-press' ); ?>" target="_blank" href="<?php echo esc_url( get_theme_mod( 'sprofile_link_tumblr' ) ); ?>"><span class="fa fa-tumblr social_profile-icon-clr"></span></a>
			<?php
			}
			?>
			...
			{
			?>
				<a title="<?php _e( 'WhatsApp', 'business-press' ); ?>" target="_blank" href="whatsapp://send?text=Hi&phone=<?php echo esc_attr( get_theme_mod( 'sprofile_link_whatsappno' ) ); ?>&abid=<?php echo esc_attr( get_theme_mod( 'sprofile_link_whatsappno' ) ); ?>"><span class="fa fa-whatsapp social_profile-icon-clr"></span></a>
			<?php
			}
			?>
