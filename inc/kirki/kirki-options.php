...
business_press_option::add_field( 'business_press_config', array(
	...
	'section'     => 'color_options',
	'default'     => '<div style="padding: 10px;background-color: #333; color: #fff; border-radius: 8px;">More color options are available in Business Press Pro Version.</div>',
	'priority'    => 10,
) );
...
business_press_option::add_field( 'business_press_config', array(
	...
	'label'       => esc_attr__( 'More Options', 'business-press' ),
	'section'     => 'header_settings',
	'default'     => '<div style="padding: 10px;background-color: #333; color: #fff; border-radius: 8px;">More options are available in Business Press Pro Version.</div>',
	'priority'    => 10,
) );
...
business_press_option::add_section( 'sidebarmenu_options', array(
...
business_press_option::add_field( 'business_press_config', array(
	...
	'section'     => 'sidebarmenu_options',
	'default'     => '<div style="padding: 10px;background-color: #333; color: #fff; border-radius: 8px;">Color options are available in Business Press Pro Version.</div>',
	'priority'    => 10,
	'active_callback'  => array(
		array(
			'setting'  => 'sb_menu_onoff',
...
if( class_exists( 'WooCommerce' ) )
{
	...
	business_press_option::add_field( 'business_press_config', array(
		...
		'description' => esc_attr__( 'Enable/Disable gallery zoom support on single product. (Please save and reload)', 'business-press' ),
		'section'     => 'woocommerce_options',
		'default'     => '1',
		'priority'    => 10,
	) );
	...
	business_press_option::add_field( 'business_press_config', array(
		...
		'description' => esc_attr__( 'Enable/Disable gallery light box support on single product. (Please save and reload)', 'business-press' ),
		'section'     => 'woocommerce_options',
		'default'     => '1',
		'priority'    => 10,
	) );
	...
	business_press_option::add_field( 'business_press_config', array(
		...
		'description' => esc_attr__( 'Enable/Disable gallery slider support on single product. (Please save and reload)', 'business-press' ),
		'section'     => 'woocommerce_options',
		'default'     => '1',
		'priority'    => 10,
	) );
...
business_press_option::add_field( 'business_press_config', array(
	...
	'active_callback'  => array(
		array(
			'setting'  => 'business_press_number_of_footer_widgets',
			'operator' => '!=',
			'value'    => 0,
		)
	)
